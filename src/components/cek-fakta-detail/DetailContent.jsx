        ...
        <div className="space-y-10 text-brand-text">
            ...
            <section>
                ...
                {content.visual.imageUrl ? (
                    ...
                    <div className="bg-indigo-100 rounded-xl aspect-video flex items-center justify-center relative mb-6 overflow-hidden border border-indigo-50">
                        ...
                        <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm text-xs font-mono px-3 py-1.5 rounded-md text-indigo-900 font-medium border border-slate-200 shadow-sm">{content.visual.imagePlaceholder}</div>
                    </div>
                )}

                <p className="leading-relaxed text-slate-700">{content.visual.description}</p>
            </section>
            ...
            <section>
                ...
                <div className="bg-slate-50 border-l-4 border-red-600 rounded-r-xl p-6">
                    <p className="font-bold text-brand-text mb-3">{content.kesimpulan.title}</p>
                    <p className="text-sm text-slate-600 leading-relaxed">{content.kesimpulan.description}</p>
                </div>
            </section>
        </div>
    );
